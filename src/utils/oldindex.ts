...
//   const isTyping = trpc.chat.isTyping.useMutation();
...
//           to write.
//         </p>
//         <button onClick={() => signIn()} data-testid="signin" className="btn">
//           Sign In
//         </button>
//       </div>
//     );
...
//   trpc.chat.whoIsTyping.useSubscription(undefined, {
//     onData(data) {
...
//                     <li>
//                       We have a simple backend subscription on new messages that adds the newly
